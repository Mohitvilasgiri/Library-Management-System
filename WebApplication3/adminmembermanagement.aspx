                            ...
                            <div class="col-md-4">
                             ...
                             <div class="form-group">
                                 ...
                                 <asp:TextBox CssClass="form-control" ID="TextBox11" 
                                     runat="server" placeholder="Pin Code" ReadOnly="True" TextMode="Number"></asp:TextBox>
                             </div>
                            </div>
                ...
                <div class="col-md-12">
                             ...
                             <div class="form-group">
                                 ...
                                 <asp:TextBox CssClass="form-control" ID="TextBox12" 
                                     runat="server" placeholder="Address" TextMode="MultiLine" ReadOnly="True" Rows="2"></asp:TextBox>
                             </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-8 mx-auto">
                                ...
                                <asp:Button class="btn btn-lg btn-block btn-danger" ID="Button1"
                                    runat="server" Text="Delete User Permanently" OnClick="Button1_Click" /> 
